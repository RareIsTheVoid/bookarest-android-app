...
//        Log.v("testing", s);
        ...
        List<BookCover> coversData = new ArrayList<BookCover>();
        coversData = loadCoversData();
//        for (BookCover c: coversData) {
...
//        }
    ...
    public List<BookCover> loadCoversData() {
    ...
    private void aaa(DataSnapshot dataSnapshot){
        Log.v("fb", dataSnapshot.child("1").child("name").getValue().toString());
    }
}